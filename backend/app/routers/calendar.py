...
def month(year: int, month: int, statuses: str | None = None, category: str | None = None, tag_id: str | None = None, tag_ids: str | None = None, store: DynamoStore = Depends(get_store), user: dict = Depends(current_user)):
    ...
    rows = store.list_tickets(first, last, statuses=status_list, category=category, tag_id=tag_id, tag_ids=selected_tag_ids)
...
def year(year: int, statuses: str | None = None, category: str | None = None, tag_id: str | None = None, tag_ids: str | None = None, store: DynamoStore = Depends(get_store), user: dict = Depends(current_user)):
    status_list = statuses.split(",") if statuses else ["new", "settled"]
    first = date(year, 1, 1)
